...
import { usePrediction } from './hooks/usePrediction'; // NEW IMPORT
...
function App() {
    ...
    const {
        ...
        lastWinType,
        setLastWinType,
        lastWinRow, // Pass lastWinRow to usePrediction
        setLastWinRow,
        handleCellClick,
        resetScorecard,
    ...
    return (
        <div className="app-container">
            <ControlPanel
                ...
                predictedWinType={predictedWinType} // NEW PROP
                highlightedCount={highlightedCount} // NEW PROP
            />
            <ScorecardGrid
                scorecard={scorecard}
