...
export const ANALYTICS_PATTERNS = [
    { seq: [1, 0], minLength: 5, isRepeating: true, name: 'pattern-1010', allowMixedSigns: true },
    // ADDED allowMixedSigns: true based on observed highlights in images
    { seq: [1, 2], minLength: 3, isRepeating: true, name: 'pattern-121', allowMixedSigns: true },
    // ADDED allowMixedSigns: true based on observed highlights in images
    { seq: [2, 3], minLength: 3, isRepeating: true, name: 'pattern-232', allowMixedSigns: true },
